...
class VideoService:
    def __init__(self):
        ...
        cookies_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'cookies_1.txt')
        print(f"[VIDEO] Looking for cookies at: {cookies_path}")
        print(f"[VIDEO] Cookies file exists: {os.path.exists(cookies_path)}")
